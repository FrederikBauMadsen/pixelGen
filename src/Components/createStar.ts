...
export default function createStar({
  ...
  for (
    var surroundDiagonalsFill = 1;
    surroundDiagonalsFill < size / 2 - 1;
    surroundDiagonalsFill++
  ) {
    //horizontal
    starArray.push(
      pixel +
        columns * surroundDiagonalsFill +
        pixelSpace * (surroundDiagonalsFill + 1)
    );
    starArray.push(
      pixel +
        columns * surroundDiagonalsFill -
    ...
    starArray.push(
      pixel +
        pixelSpace * surroundDiagonalsFill +
        columns * (surroundDiagonalsFill + 1)
    );
    starArray.push(
      pixel +
        pixelSpace * surroundDiagonalsFill -
